    ...
    try {
        ...
        const endpoint =
            route.name === "category"
                ...
                : `/api/subcategory/${slug}/products`;

        const { data } = await axios.get(endpoint);
        products.value = data.products.data;
        links.value =   data.products.links;
...
watch(() => route.params.slug, fetchProducts, { immediate: true });
...
<template>
    ...
    <h5 v-if="category " style="color: #409b54;">
        {{ category.cat_name }}
    </h5>
    <h5 v-else-if="subcategory" style="color: #409b54;">
         {{ subcategory.cat.cat_name }} >  {{ subcategory.subcat_name }}
    </h5>
</div>
            ...
            <div class="product-item" v-for="product in products" :key="product.id">
                <div class="product-cart-wrap mb-30">
                    ...
                    <div class="product-content-wrap">
                        <div class="product-category"><a href="shop-grid-right.html"></a></div>
                        ...
                        <div class="product-card-bottom">
                            ...
                            <div class="add-cart"><a class="add" :href="product.slug">View</a></div>
                        </div>
                    </div>
                </div>
            </div>
