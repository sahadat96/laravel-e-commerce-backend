									...
									<div class="row mb-3">
									 @if (Session::has('message'))
         							 @endif
											...
											<div class="col-sm-9">
												<input name="brand_name" type="text" class=" form-control" id="brand_name" placeholder="Enter Brand Name">
											</div>
										</div>
										<div class="row mb-3">
											<label for="" class="col-sm-3 col-form-label">Brand Image</label>
											<div class="col-sm-9">
